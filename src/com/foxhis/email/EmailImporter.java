...
public abstract class EmailImporter implements ContactsImporter {
    ...
    private void setHeaders(HttpMethod method) {
        ...
        method.setRequestHeader("Cookie", "route=4817eb65d93784a45f617f8080270107; wm_custom_login_username=tq8; wm_custom_login_wm_ssl=0; route=a44e87e72059d8573abe802f4f133c1d; cid_tq8_foxhis.com=TW5RMGNUYzRNRUE0WmpOdk1uZ3dhREJw");
        method.setRequestHeader("Connection","keep-alive");
        method.setRequestHeader("Host", "mail.foxhis.com");
        method.setRequestHeader("Cache-Control", "max-age=0");
        method.setRequestHeader("Upgrade-Insecure-Requests", "1");
        method.setRequestHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.110 Safari/537.36");
    }
